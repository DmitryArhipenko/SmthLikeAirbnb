...
public class AdvertismentValidator implements Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        if (advertismentService.findByTitle(advertisment.getTitle()) != null) {
            errors.rejectValue("title", "Duplicate.title");
        }

        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "is_available", "NotEmpty");

        ValidationUtils.rejectIfEmptyOrWhitespace(errors, "apartment_type", "NotEmpty");
